...
describe("UxTestDashboardReport", () => {
  it("renders the research setup and primary result", () => {
    ...
    expect(screen.getByText("11 current / 11 new valid participants")).toBeTruthy();
    expect(screen.getByText("$50")).toBeTruthy();
    expect(screen.getAllByText("45.4%").length).toBeGreaterThan(0);
    expect(screen.getAllByText("100%").length).toBeGreaterThan(0);
    expect(screen.getAllByText("48.3 sec").length).toBeGreaterThan(0);
    expect(screen.getAllByText("86.3 sec").length).toBeGreaterThan(0);
    expect(screen.getByText("11 of 11 completed")).toBeTruthy();
